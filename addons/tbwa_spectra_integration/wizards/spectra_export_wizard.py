...
class SpectraExportWizard(models.TransientModel):
    ...
    ], default='cash_advance', required=True, string='Export Type')

    # Preview fields
    preview_count = fields.Integer(string='Records to Export', readonly=True)
    preview_total_amount = fields.Monetary(string='Total Amount', readonly=True,
    ...
    def action_generate(self):
        ...
        try:
            ...
            _logger.error(f"Failed to generate CSV for export batch {export_batch.name}: {e}")
