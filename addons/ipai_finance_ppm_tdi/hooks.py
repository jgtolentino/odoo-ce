...
def post_init_hook(cr, registry):
    ...
    for data_file in data_files:
        try:
            ...
            module.load_data(
                cr, module_name, data_file, idref={}, mode="init", noupdate=True
            )
    ...
    _logger.info("Expected: 52 BIR, 27 LogFrame, 38 PH Holidays")

    if bir_count == 52 and logframe_count == 27 and holiday_count == 38:
        _logger.info("✅ All seed data loaded successfully!")
    else:
        _logger.warning("⚠️ Seed data counts don't match expected values")
