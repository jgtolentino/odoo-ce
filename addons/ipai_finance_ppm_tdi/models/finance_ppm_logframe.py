...
class FinancePPMLogFrame(models.Model):
    ...
    description = fields.Text(
        string="Description", help="Detailed description of this logframe element"
    )
    ...
    measurement_frequency = fields.Selection(
        ...
        help="How often this KPI is measured",
    )
    ...
    child_ids = fields.One2many(
        "finance.ppm.logframe", "parent_id", string="Child Elements"
    )
