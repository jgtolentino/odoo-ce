...
class FinancePPMPHHoliday(models.Model):
    ...
    date = fields.Date(
        string="Holiday Date", required=True, help="Date of the Philippine holiday"
    )
    name = fields.Char(
        string="Holiday Name",
        required=True,
    ...
    holiday_type = fields.Selection(
        ...
        string="Holiday Type",
        required=True,
        help="Classification of holiday under Philippine law",
    )
    ...
    description = fields.Text(
        string="Description", help="Additional information about the holiday"
    )
