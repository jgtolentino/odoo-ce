CREATE OR REPLACE VIEW monitoring.v_service_uptime_daily AS
SELECT
  service_name,
...
CREATE OR REPLACE VIEW monitoring.v_backup_status_daily AS
SELECT
  source_db,
...
FROM monitoring.backup_verifications
